...
namespace UnityEditor.Formats.Fbx.Exporter {
    ...
    public class ExportSettings : ScriptableObject
    {
        ...
        public List<string> GetCopyOfPrefabSavePaths()
        {
        ...
        public List<String> GetCopyOfFbxSavePaths()
        {
        ...
        [SecurityPermission(SecurityAction.InheritanceDemand, Flags = SecurityPermissionFlag.UnmanagedCode)]
        [SecurityPermission(SecurityAction.LinkDemand, Flags = SecurityPermissionFlag.UnmanagedCode)]
        public static string AskMayaVersion(string exePath) {
        ...
        /// </summary>
        public static string[] GetMixedSavePaths(List<string> exportSavePaths)
        {
        ...
        /// Only returns the paths within the Assets folder of the project.
        /// </summary>
        public static string[] GetRelativeFbxSavePaths(List<string> fbxSavePaths, ref int pathIndex)
        {
        ...
        /// </summary>
        public static string[] GetMixedFbxSavePaths()
        {
        ...
        public static void AddSavePath(string savePath, List<string> exportSavePaths, bool exportOutsideProject = false){
            if(exportSavePaths == null)
            {
                return;
            }
        ...
        public static void AddFbxSavePath(string savePath, bool exportOutsideProject = false){
